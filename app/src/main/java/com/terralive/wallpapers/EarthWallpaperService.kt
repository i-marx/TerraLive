...
class EarthWallpaperService : WallpaperService() {
    ...
    inner class TerraEngine : Engine() {
        ...
        private val prefListener = SharedPreferences.OnSharedPreferenceChangeListener { _, key ->
            if (key == Wallpapers.KEY_SELECTED || key == Wallpapers.KEY_MODE || key == Wallpapers.KEY_LOCK || key == Wallpapers.KEY_LAT || key == Wallpapers.KEY_LON || key == Wallpapers.KEY_LOOK || key == Wallpapers.KEY_MOTION || key == Wallpapers.KEY_ROT || key == Wallpapers.KEY_COSMOS) {
